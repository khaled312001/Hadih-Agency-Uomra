...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>لقد تلقيت رسالة جديدة من <strong>{{ $sender->name }}</strong></p>
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $sender->name }} ({{ $sender->email }})</span>
            </div>
            ...
            <div style="background: #e3f2fd; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="margin: 0; color: #1976d2;">
                    <strong>💡 نصيحة:</strong> يمكنك الرد على هذه الرسالة مباشرة من خلال تطبيق هدية أو زيارة الموقع.
                </p>
            </div>
        </div>
